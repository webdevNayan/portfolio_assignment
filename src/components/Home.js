...
const Home = ({ dark }) => {
  ...
  const { name, title, address, subTitle } = useSelector((state) => state.user?.user?.user?.about) || {};
  const { url } = useSelector((state) => state.user?.user?.user?.about?.avatar) || {};
            ...
            <div className="details">
              ...
              <div className="job">
                <p>
                  ...
                  A <span className="greenText"> {title} </span>{" "}
                  From <span className="purpleText">{address} </span>
                </p>
              </div>
              <div className="text">
                {/* <p>{data.bio}</p> */}
